...
if ( ! class_exists( 'PremiumForms' ) ) {
	...
	class PremiumForms extends FormHandler implements IFormHandler {
		...
		protected function __construct() {
			$this->form_name      = sanitize_text_field( isset( $_GET['form_name'] ) ? wp_unslash( $_GET['form_name'] ) : '' );// phpcs:ignore WordPress.Security.NonceVerification.Missing, WordPress.Security.NonceVerification.Recommended -- Reading GET parameter from the URL for checking the form name, doesn't require nonce verification.
