...
$sms_settings->available_tags = '{site-name},{username},{accountpage-url}';
$sms_settings->available_tags = apply_filters( 'available_prem_tags', $sms_settings->available_tags, 'wc_new_customer_notif' );
