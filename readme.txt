...
Some Famous SMS Gateways Supported: 
...
Check the list of supported SMS gateways here : [SMS Gateways](https://plugins.miniorange.com/supported-sms-email-gateways)
Test the compatibility of your Custom Gateway here: [Test your Gateway](https://login.xecurify.com/moas/login?redirectUrl=https://login.xecurify.com/moas/admin/customer/smsconfig)
Contact us at **otpsupport@xecurify.com/info@xecurify.com** to know more.

= WHATSAPP OTP VERIFICATION & NOTIFICATIONS = 
Enable **OTP Verification and SMS Notifications over WhatsApp** in our OTP Verification plugin.
Enables WooCommerce order status notifications, Custom SMS notifications and many more on WhatsApp.
Use your own WhatsApp buisness account for sending the OTPs and notifications.
Contact us at **otpsupport@xecurify.com/info@xecurify.com** to know more.

== FREE AND PREMIUM OTP VERIFICATION ADDONS SUPPORTED == 
Check the free and premium addons supported in the OTP Verification plugin : [OTP Verification Addons Supported](https://plugins.miniorange.com/wordpress-otp-verification#otp_verification_addons)
...
This is an add-on which allows **Login on your Wordpress site using only Phone Number instead of Email address or Username and password.**
...
This is an add-on which replaces the existing **Password reset functionality with OTP Verification**. Allow users to reset their password using OTP Verification instead of email links.
...
= BULK SMS AND OTP =
This is an add-on which allows **Admin to send Custom SMS in bulk**. Contact us at **otpsupport@xecurify.com/info@xecurify.com** to know more.
