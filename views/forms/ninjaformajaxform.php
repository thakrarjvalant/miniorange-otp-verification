...
echo '							<div class="mo_registration_help_desc" ' . esc_attr( $ninja_ajax_form_hidden ) . ' id="ninja_ajax_form_options">
									...
									<div ' . ( esc_attr( $ninja_ajax_form_enabled_type ) !== esc_attr( $ninja_ajax_form_type_email ) ? 'style=display:none' : '' ) . ' class="mo_registration_help_desc" id="nfae_instructions" >
...
echo '											</li>
									...
									<div ' . ( esc_attr( $ninja_ajax_form_enabled_type ) !== esc_attr( $ninja_ajax_form_type_phone ) ? 'style=display:none' : '' ) . ' class="mo_registration_help_desc" id="nfap_instructions" >
