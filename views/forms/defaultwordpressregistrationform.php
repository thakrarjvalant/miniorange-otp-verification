...
echo '
				...
				<div ' . ( esc_attr( $wp_default_type ) !== esc_attr( $wpreg_phone_type ) ? 'style=display:none' : '' ) . ' class="mo_registration_help_desc" 
				...
				<p>
					<input type="radio" ' . esc_attr( $disabled ) . ' id="wp_default_both" class="app_enable" name="mo_customer_validation_wp_default_enable_type" 
						...
						<strong>' . esc_html( mo_( 'Let the user choose' ) ) . '</strong>';
							...
							echo '			</p>
				<div ' . ( esc_attr( $wp_default_type ) !== esc_attr( $wpreg_both_type ) ? 'style=display:none' : '' ) . ' class="mo_registration_help_desc" 
