...
echo '   
        <div class="mo_otp_form" id="' . esc_attr( get_mo_class( $handler ) ) . '">
            ...
            <div class="mo_registration_help_desc" ' . esc_attr( $is_easyreg_hidden ) . ' id="easyreg_options">
                ...
                <div ' . ( esc_attr( $easyreg_enabled_type ) !== esc_attr( $easyreg_email_type ) ? 'hidden' : '' ) . ' class="mo_registration_help_desc" id="easyreg_email_option"">
                    <ol>
                        <li><a href="' . esc_url( $easyreg_form_list ) . '" target="_blank">' . esc_html( mo_( 'Click Here' ) ) . '</a> 
                        ...
                        <li>' . esc_html( mo_( 'Enter your Form ID, Email Field Lebel and Verification Field Label below' ) ) . ':<br>
                            ...
                            onclick="add_easyreg(\'email\',1);" class="button button-primary" />&nbsp;

                            <input type="button" value="-" ' . esc_attr( $disabled ) . ' onclick="remove_easyreg(1);" class="button button-primary" />
                            <br/><br/>';
...
echo '              </ol>
                ...
                <div ' . ( esc_attr( $easyreg_enabled_type ) !== esc_attr( $easyreg_phone_type ) ? 'hidden' : '' ) . ' class="mo_registration_help_desc" 
                      ...
                      <li><a href="' . esc_url( $easyreg_form_list ) . '" target="_blank">' . esc_html( mo_( 'Click Here' ) ) . '</a> 
                        ...
                        <li>' . esc_html( mo_( 'Enter your Form ID, Email Field Lebel and Verification Field Label below' ) ) . ':<br>
                            <br/>' . esc_html( mo_( 'Add Form ' ) ) . ': <input type="button"  value="+" ' . esc_attr( $disabled ) . ' onclick="add_easyreg(\'phone\',2);
                                ...
                                onclick="remove_easyreg(2);" class="button button-primary" /><br/><br/>';
...
echo '</ol>
                    ...
                    <p style="margin-left:2%;">
                        ...
                        <input class="mo_registration_table_textbox" name="mo_customer_validation_easyreg_button_text" type="text" value="' . esc_attr( $button_text ) . '">
                    </p>             
                </div>
        </div>';
