                    ...
                    <div class="mo-pricing-snippet-grid">
                        ...
                        <div class="mo-pricing-card">
                            ...
                            <ul class="mt-mo-6 grow" >
                                ...
                                <li class="feature-snippet">
                                    <span class="mt-mo-1">' . wp_kses( $circle_icon, MoUtility::mo_allow_svg_array() ) . '</span>
                                    <p class="m-mo-0">Tutor LMS Login & Registration Forms Supported</p>
                                </li>                            
                            </ul>
                ...
                <div id="addons-grid" class="mo-addon-section-container ">
                    <div class="mo-addon-card">
                        <div class="grow">
                            ...
                            <span style="float:right;margin-top:15px; font-size:160%; font-weight:bold;">$19</span>
                        ...
                        <a href="https://plugins.miniorange.com/how-to-configure-woocommerce-password-reset-addon" target="_blank" class="flex-1 mr-mo-1  mo-button secondary "  >  Know More </a>
                        <button class="flex-1 mo-button inverted ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! I am interested in the WooCommerce Password Reset Over OTP addon, could you please tell me more about this addon?\');"> Get Addon</button>
                        </div>
                        </div>
                    ...
                    <div class="mo-addon-card">
                        <div class="grow">
                                ...
                                <svg width="50" height="50" viewBox="0 0 100 100" fill="none">
                                  ...
                                  <span style="float:right;margin-top:15px; font-size:160%; font-weight:bold;">$49</span>
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a href="https://plugins.miniorange.com/how-to-configure-limit-otp-request-addon" target="_blank" class="flex-1 mr-mo-1  mo-button secondary "  >  Know More </a>
                        <button class="flex-1 mo-button inverted ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! I am interested in the Limit OTP Request addon, could you please tell me more about this addon?\');"> Get Addon</button>
                        </div>
                        </div>
                        ...
                        <span style="float:right;margin-top:15px; font-size:160%; font-weight:bold;">$49</span>
                            ...
                            <p class="mt-mo-6 font-bold">OTP on Selected Product Category</p>

                            <li class="feature-snippet">
                                <span class="mt-mo-1">' . wp_kses( $circle_icon, MoUtility::mo_allow_svg_array() ) . '</span>
                                <p class="m-mo-0">OTP verification will be enabled on the selected product category.</p>
                            </li>

                            <li class="feature-snippet">
                                <span class="mt-mo-1">' . wp_kses( $circle_icon, MoUtility::mo_allow_svg_array() ) . '</span>
                                <p class="m-mo-0">All Woocommerce categories supported.</p>
                            </li>                            

                        </div>
                        <div class="flex w-full mt-mo-4 justify-center">
                        <a  class="flex-1 mr-mo-1  mo-button secondary" onclick="otpSupportOnClick(\'Hi! I am interested in the OTP on Selected Product Category addon, could you please tell me more about this addon?\');"  >  Know More </a>
                        <button class="flex-1 mo-button secondary inverted ml-mo-2 "  onclick="otpSupportOnClick(\'Hi I am interested in the Selected Product Category addon, could you please share the payment details for this addon?\');"> Get Addon</button>
                        </div>
                        </div>    
                    ...
                    <div class="mo-addon-card">
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a href="https://plugins.miniorange.com/how-to-configure-wordpress-sms-notification-addon" target="_blank" class="flex-1 mr-mo-1  mo-button secondary "  >  Know More </a>
                        <button class="flex-1 mo-button inverted ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! I am interested in the WordPress SMS Notification to Admin & User on Registration addon, could you please tell me more about this addon?\');"> Get Addon</button>
                        </div>
                    ...
                    <div class="mo-addon-card">
                        <div class="grow">
                                ...
                                <span style="float:right;margin-top:15px; font-size:160%; font-weight:bold;">$39</span>
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a href="https://plugins.miniorange.com/otp-verification-for-selected-countries" target="_blank" class="flex-1 mr-mo-1  mo-button secondary"  >  Know More </a>
                        <button class="flex-1 mo-button inverted ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! I am interested in the OTP Verification for Selected Countries Only addon, could you please tell me more about this addon?\');"> Get Addon</button>
                        </div>
                       </div> 
                    ...
                    <div class="mo-addon-card">
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a href="https://plugins.miniorange.com/how-to-configure-register-using-only-phone-addon" target="_blank" class="flex-1 mr-mo-1  mo-button secondary"  >  Know More </a>
                        <button class="flex-1 mo-button inverted ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! I am interested in the Register Using Only Phone Number addon, could you please tell me more about this addon?\');"> Get Addon</button>
                        </div>
                    </div>
                    ...
                    <div class="mo-addon-card">
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a href="https://plugins.miniorange.com/how-to-configure-wordpress-password-reset-addon" target="_blank" class="flex-1 mr-mo-1  mo-button secondary "  >  Know More </a>
                        <button class="flex-1 mo-button inverted ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! I am interested in the WordPress Password Reset Over OTP addon, could you please tell me more about this addon?\');"> Get Addon</button>
                        </div>
                    </div>
                    ...
                    <div class="mo-addon-card">
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a href="https://plugins.miniorange.com/how-to-configure-otp-over-call-addon" target="_blank" class="flex-1 mr-mo-1  mo-button secondary"  >  Know More </a>
                        <button class="flex-1 mo-button inverted  ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! I am interested in the OTP Over Phone Call addon, could you please tell me more about this addon?\');"> Get Addon</button>
                        </div>
                    </div> 
                    ...
                    <div class="mo-addon-card">
                        ...
                        <div class="flex w-full mt-mo-4 justify-center">
                        <a  class="flex-1 mr-mo-1  mo-button secondary" onclick="otpSupportOnClick(\'Hi I am interested in the Country Code Dropdown addon, could you please tell me more about this addon?\');"  >  Know More </a>
                        <button class="flex-1 mo-button inverted secondary ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! Could you please share the payment details for the Country Code Dropdown addon?\');"> Get Addon</button>
                        </div>
                    </div>
                    ...
                    <div class="mo-addon-card">
                        <div class="grow">
                            ...
                            <span style="float:right;margin-top:15px; font-size:160%; font-weight:bold;">$89</span>
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a  class="flex-1 mr-mo-1  mo-button secondary" onclick="otpSupportOnClick(\'Hi! I am interested in the OTP Verification for Android/IOS Application addon, could you please tell me more about this addon?\');"  >  Know More </a>
                        <button class="flex-1 mo-button inverted  ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! Could you please share the payment details for the  OTP Verification for Android/IOS Application addon?\');"> Get Addon</button>
                        </div>
                    ...
                    <div class="mo-addon-card">
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a  class="flex-1 mr-mo-1  mo-button secondary" onclick="otpSupportOnClick(\'Hi! I am interested in the Login Using Only Phone Number addon, could you please tell me more about this addon?\');"  >  Know More </a>
                        <button class="flex-1 mo-button inverted  ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! Could you please share the payment details for the Login Using Only Phone Number addon?\');"> Get Addon</button>
                        </div>
                    ...
                    <div class="mo-addon-card">
                        ...
                        <div class="flex w-full mt-mo-4 justify-center item-center">
                        <a  class="flex-1 mr-mo-1  mo-button secondary" onclick="otpSupportOnClick(\'Hi! I am interested in the Verification via Email Link instead of One time Passcode addon, could you please tell me more about this addon?\');"  >  Know More </a>
                        <button class="flex-1 mo-button inverted  ml-mo-2 "  onclick="otpSupportOnClick(\'Hi! Could you please share the payment details for the Verification via Email Link instead of One time Passcode addon?\');"> Get Addon</button>
                        </div>
...
echo '
    <script>
        ...
        pricingTabItem.addEventListener("click",function(){
            window.open(`${origin}${pathname}?page=mootppricing`,\'_self\');
        })
        addonsTabItem.addEventListener("click",function(){
            window.open(`${origin}${pathname}?page=mootppricing&subpage=premaddons`,\'_self\');
        })
